...
import { BadgeComponent, Button, Card, Input, Menu, MenuItem, MenuTrigger, ToastService } from '@vm/ui';

@Component({
  selector: 'app-home',
  imports: [Button, NgIcon, MenuTrigger, Menu, MenuItem, Card, Input, BadgeComponent],
